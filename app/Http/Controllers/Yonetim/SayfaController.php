...

{
...

    {
...

        {
            ...
            if ( request('alt_menu') == 'evet' ) {
                ...
                Icerikler::create(['sayfasi' => $sayfa->id, 'name' => $data['name'], 'label' => stripcslashes($data['label']) ,'icerik' => stripcslashes($data['icerik'])]);
                ...
                if ($data['belong'] != 0) {
                    ...
                    if ($varmi->icerigi == NULL) {
                        ...
                        Icerikler::create(['sayfasi' => $data['belong'], 'name' => $data['name'], 'label' => stripcslashes($data['label']) ,'icerik' => stripcslashes($data['icerik'])]);
        ...
        return view('yonetim.sayfalar.ekle', compact('sayfalar', 'input', 'galeri'));
...

    {
...

        {
            ...
            $gelen->update(['il' => $data['il'] ,'ilce' => $data['ilce'] ,'sayfasi' => $data['belong'] ,'name' => stripcslashes($data['name']), 'label' => stripcslashes($data['label']) ,'icerik' => stripcslashes($data['icerik'])]);
        ...
        return view('yonetim.sayfalar.duzenle', compact('sayfalar', 'gelen', 'iller', 'ilceler'));
