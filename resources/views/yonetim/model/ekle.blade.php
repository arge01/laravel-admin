...
@section('content')
    <form action="{{ route('yonetim.model.ekle', $urun->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <h4 class="heading-ext">{!! $urun->name !!} Ürün'e Model Ekle <span style="font-size: 7pt">Boyutları: 370 X 492</span></h4>
                            ...
                            <div class="uk-form-row">
                                ...
                                <textarea required name="label" class="md-input" cols="10" rows="8" data-parsley-trigger="keyup"
                            ...
                            <div class="uk-form-row">
                                <div class="parsley-row">
                                    ...
                                    <select disabled id="kategori" name="urun" multiple>
                                        <option selected value="{{ $urun->id }}">{!! $urun->name !!}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                            ...
                            <div class="uk-form-row">
                                ...
                                <textarea name="text" id="wysiwyg_ckeditor" cols="30" rows="20"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
