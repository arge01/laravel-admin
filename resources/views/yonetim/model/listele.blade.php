...
@section('content')
    ...
    <div id="page_content_inner">
        ...
        <div class="md-card">
            ...
            <div class="md-card-content">
                ...
                <h4 class="heading-ext">{!! $proje->name !!} Modelleri</h4>
                            ...
                            <tr id="tr-{{ $urun->id }}">
                                ...
                                <td>
                                    @if( count($urun->galerisi) > 0 )
                                        <a target="_blank" href="{{ route('yonetim.galeri.listele', 'data=urun&key='.$urun->id) }}">EKLENMİŞ / DÜZENLE</a>
                                    @else
                                        <a target="_blank" href="{{ route('yonetim.galeri.ekle', 'data=urun&key='.$urun->id) }}">EKLENMEMİŞ / EKLE</a>
                                    @endif
                                </td>
                                <td>{{ date('m-d-Y', strtotime($urun->olusturma_tarihi)) }}</td>
                                <td class="uk-text-center">
                                    <a href="{{ route('yonetim.model.duzenle', $urun->id) }}"><i class="md-icon material-icons">&#xE254;</i></a>
    ...
    <div class="md-fab-wrapper">
        ...
        <a title="Yeni Ekle" class="md-fab md-fab-accent" href="{{ route('yonetim.model.ekle', $proje->id) }}">
