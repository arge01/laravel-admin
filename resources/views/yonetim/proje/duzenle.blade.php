...
@section('content')
    <form action="{{ route('yonetim.proje.duzenle', $gelen->id) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <h4 class="heading-ext">Proje Güncelle</h4>
                            ...
                            <div class="uk-form-row">
                                <div class="parsley-row">
                                    ...
                                    <select id="kategori" name="kategori[]" multiple>
                                        @if($gelen->kategori != NULL)
                                        <option selected value="{{ $gelen->kategori }}">{{ $gelen->kategorisi->name }}</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="uk-form-row">
                                ...
                                <textarea name="icerik" id="wysiwyg_ckeditor" cols="30" rows="20">{{ $gelen->icerik }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
