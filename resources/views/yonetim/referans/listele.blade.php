...
@section('content')
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-content">
                <h4 class="heading-ext">Referanslar</h4>
    ...
    <div class="md-fab-wrapper">
        <a title="Yeni Ekle" class="md-fab md-fab-accent" href="{{ route('yonetim.referans.ekle') }}">
...
@section('javascript')
    ...
    <script>
        ...
        function edit(ID) {
            $.get('{{ config('app.url') }}yonetim/referans/duzenle/'+ID, function(data){
        ...
        function del(ID) {
            $.ajax({
                type: 'POST',
                url: '{{ route('yonetim.referans.sil') }}',
                data: {
                    ID: ID
                },
                dataType: 'json',
                ...
                error: function (data) {
                    ...
                    swal({
                        type: 'error',
                        title: 'Hata...',
                        text: 'Referans Silinirken Hata Oluştu!',
                        confirmButtonText: 'Tamam'
                    });
                }
