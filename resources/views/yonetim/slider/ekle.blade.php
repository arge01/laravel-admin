...
@section('content')
    <form action="{{ route('yonetim.slider.ekle') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <h4 class="heading-ext">Slider Ekle <span style="font-size: 7pt">Boyutları: 1920 X 1080</span></h4>
