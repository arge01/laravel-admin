...
@section('content')
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-content">
                <h4 class="heading-ext">Sliderlar</h4>
                        ...
                        @foreach($sliderlar as $i => $slider)
                            <tr id="tr-{{ $slider->id }}">
                                ...
                                <td class="uk-text-center">
                                    <a href="{{ route('yonetim.slider.duzenle', $slider->id) }}"><i class="md-icon material-icons">&#xE254;</i></a>
    ...
    <div class="md-fab-wrapper">
        <a title="Yeni Ekle" class="md-fab md-fab-accent" href="{{ route('yonetim.slider.ekle') }}">
