...
@section('content')
                ...
                <div class="uk-overflow-container uk-margin-bottom">
                    <table class="uk-table uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        @foreach($urunler as $i => $urun)
                            <tr id="tr-{{ $urun->id }}">
                                <td><img src="{{ config('app.url').'images/'.$urun->img }}" alt=""></td>
                                <td>{{ $i }}</td>
                                <td>{{ $urun->name }}</td>
                                <td>
                                ...
                                <td class="uk-text-center">
                                    <a href="{{ route('yonetim.urun.duzenle', $urun->id) }}"><i class="md-icon material-icons">&#xE254;</i></a>
    ...
    <div class="md-fab-wrapper">
        <a title="Yeni Ekle" class="md-fab md-fab-accent" href="{{ route('yonetim.urun.ekle') }}">
