...
@section('content')
    <form action="{{ route('yonetim.yonetici.ayarlar') }}" method="post">
        {{ csrf_field() }}
                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <h4 class="heading-ext">Şifre ayarları</h4>
                            <div class="uk-form-row">
                                <label>Mail</label>
                                <input type="text" class="md-input" name="mail" required value="{{ $yonetici->email }}"/>
                            </div>
                            <div class="uk-form-row">
                                <label>Üye Adı</label>
                                <input type="text" class="md-input" name="name" required value="{{ $yonetici->adsoyad }}"/>
                            </div>
                            <div class="uk-form-row">
                                <label>Eski Şifre</label>
                                <input type="password" class="md-input" name="old-password" required/>
                            </div>
                            <div class="uk-form-row">
                            ...
                            <div class="uk-form-row">
                                ...
                                <input type="password" class="md-input" name="confirm-password" required/>
                            </div>
                        </div>
                    </div>
                </div>
