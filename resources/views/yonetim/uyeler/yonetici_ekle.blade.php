...
@section('content')
    <form action="{{ route('yonetim.yonetici.ekle') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
                ...
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-medium-1-1">
                            <h4 class="heading-ext">Yönetici Ekle <span style="font-size: 8pt; color: red">(Not: Şifre girmiş olduğunuz mail adresine gönderelecektir.)</span></h4>
