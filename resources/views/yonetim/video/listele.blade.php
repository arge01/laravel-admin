...
@section('content')
    <div id="page_content_inner">
        <div class="md-card">
            <div class="md-card-content">
                <h4 class="heading-ext">Videolar</h4>
    ...
    <div class="md-fab-wrapper">
        <a title="Yeni Ekle" class="md-fab md-fab-accent" href="{{ route('yonetim.video.ekle') }}">
...
@section('javascript')
    ...
    <script>
        ...
        function edit(ID) {
            $.get('{{ config('app.url') }}yonetim/video/duzenle/'+ID, function(data){
            ...
            $.ajax({
                ...
                error: function (data) {
                    ...
                    swal({
                        type: 'error',
                        title: 'Hata...',
                        text: 'Video Silinirken Hata Oluştu!',
                        confirmButtonText: 'Tamam'
                    });
                }
